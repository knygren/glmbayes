...
#'
#' \code{rnorm_gamma_reg_temp5} is used to generate iid samples from Bayesian linear models with a normal-gamma prior. 
...
rnorm_gamma_reg_temp5<-function(n,y,x,mu,P,nu,V,offset2=NULL,wt=1){
