---
title: "Chapter 3: A Side by Side Comparison of glm and glmb"
author: "Kjell Nygren"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Chapter 3: A Side by Side Comparison of glm and glmb}
...
glmb.D93<-glmb(n=1000,counts ~ outcome + treatment, family=poisson(), prior=prior)
```
