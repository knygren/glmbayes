...
**Model Fit, Predictions, Deviance Residuals, and Covariance Matrix**
...
```{r glmb confint}
## nobs for the glm function
t(apply(glmb.D93$coefficients, 2, FUN = quantile,probs=c(0.025,0.975)))
```
