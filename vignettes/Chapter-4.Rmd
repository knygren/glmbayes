...
Prior_Likelihood_Check(mu1,
sqrt(diag(V1)),glm.out1$coefficients,Like_std)
...
#D93_Prior_Error_Checks=
Prior_Likelihood_Check(mu1,
sqrt(diag(V1)),glm.out2$coefficients,Like_std)
...
#D93_Prior_Error_Checks=
Prior_Check_3=Prior_Likelihood_Check(mu2,
sqrt(diag(V1)),glm.out3$coefficients,Like_std)
