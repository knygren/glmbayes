...
#lmb.D9=lmb(weight ~ group,dNormal(mu,V,dispersion=1))

#lmb.D9$fitted.values  # Not currently present 
#lmb.D9$linear.predictors  ## Present

#residuals(lmb.D9)

#lmb.D9$prior.weights
...
#print(lmb.D9)  # Print function not working
